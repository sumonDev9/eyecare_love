            ...
            <div className="relative z-10 flex flex-col items-center text-center text-white">
                ...
                <div className="mt-16 h-12">
                    {skipCount < 1 ? (
                        <button
                            onClick={onSkip}
                            className="rounded-full border border-slate-600 bg-slate-800/50 px-6 py-2 text-sm text-slate-400 transition-all hover:bg-slate-700 hover:text-white"
                        >
                            Skip Once (Emergency)
                        </button>
                    ) : (
